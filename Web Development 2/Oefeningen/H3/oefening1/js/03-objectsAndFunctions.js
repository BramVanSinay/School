...
myBicycle.judgeSpeed = function(){
  switch(true){
    case this.speed<10 : return "Walking...";
    case this.speed<20 : return "Brakes on...";
    case this.speed<40 : return "Pushing...";
    case this.speed<60 : return "Peleton style";
    default : return "Sagan style...";
  }
}
